...
export function trueSolarOffsetMin(y, m, d, lon) {
...
export function saju(y, m, d, hh, mm, opts) {
  opts = opts || {};
  // 진태양시 보정 → 실질 시각
...
export function tenGod(dayStem, el, yin) {
...
export function natal(y, m, d, hh, mm) {
